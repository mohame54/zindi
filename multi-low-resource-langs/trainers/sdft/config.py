...
class DistilConfig(TrainingArguments):
    ...
    max_completion_length (`int` or `None`, *optional*, defaults to `768`):
        ...
        delta (`float`, *optional*):
            ...
            GRPO clipping is used. Recommended to be greater than `1 + ε` when enabled. This method is introduced in the
            [INTELLECT-2 tech report](https://huggingface.co/papers/2505.07291).
    ...
    generation_kwargs: Optional[dict] = field(
        default=None,
        metadata={
            "help": "Additional keyword arguments to pass to `GenerationConfig` when sampling completions. This can "
            "be used to further customize the generation behavior, such as setting `suppress_tokens`, `num_beams`, "
            "etc. If it contains keys that conflict with the other generation parameters (like `min_p`, `top_p`, "
    ...
    chat_template_kwargs: Optional[dict[str, Any]] = field(
        default=None,
        metadata={
            "help": "Additional keyword arguments passed to `apply_chat_template`, such as "
            "`enable_thinking=False` for models that support disabling thinking mode."
        },
    )
    ...
    cache_implementation: Optional[str] = field(
        default=None,
        metadata={"help": "Implementation of the cache method for faster generation."},
    )
    ...
    alpha: float = field(
        default=0.0,
        metadata={
            "help": "Alpha coefficient. If `0.0` (default), the forward KL is used. If `1.0`, the reverse KL is used. "
            "If anything in between, the Jensen-Shannon Divergence is used."
        },
    )
    generate_from_teacher: bool = field(
        default=False,
        metadata={
            "help": "If True, use the teacher model (ref_model) for generation. This makes training equivalent to "
            "online SFT where the teacher generates completions and the student learns to reproduce them. "
